...
$widget.nextId('popupmenu');$widget.buttonFlyout({focusManagement:true});$rootMenu.commonKeyDown();$rootMenu.rovingTabindex('[role^=menuitem]',{axis:'y',autoReset:true});$rootMenu.prop('id',$widget.prop('id')+'-menu');$button.attr('aria-haspopup','true').prop('id',$widget.prop('id')+'-button');$subMenus.attr('aria-expanded','false');$rootMenu.on('click spaceKeyDown enterKeyDown','[role^=menuitem]',function(e){if(e.type==='enterKeyDown'){e.preventDefault();}
